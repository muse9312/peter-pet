      ...
      <b-flex xs12>
        <div class="wrapper">
          <div class="main main-raised">
            <div class="wenddy-info"></div>
            <div class="DID-page1">
              <div class="Img">
                <img
                  v-bind:src="peterpet.imgLink"
                  width="250px"
                  height="250px"
                  alt=""
                />
            ...
            <div v-else>
              ...
              <div class="page-content2">
                ...
                <h6>오늘도 {{ peterpet.name }}와 행복한 하루 되세요!</h6>
                <br />
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getWenddyInfo: function (did) {
      this.$http
        .get(`http://210.114.18.112:3000/api/wenddy/info/did/${did}`, {})
        .then((res) => {
